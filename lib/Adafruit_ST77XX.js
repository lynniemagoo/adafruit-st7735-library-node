...
class Adafruit_ST77XX extends Adafruit_SPITFT {
    ...
    constructor(options) {
        ...
        const self = this, reverseInversionMode = self._reverseInversionMode;
        //console.log("reverseInversionMode:%o", reverseInversionMode);
        // Adafruit display defaults MADCTL_VALUE to ST77XX_MADCTL_BGR.
        // Adafruit display defaults inversion to ST77XX_INVON which is really off on Dollatek or Waveshare displays.
        if (reverseInversionMode) {
            self.invertOnCommand = ST77XX_INVOFF;
            self.invertOffCommand = ST77XX_INVON;
        } else {
    ...
    */
    ...
    setRotation(m) {
        ...
        let madctl = 0, colorOrder = ST77XX_MADCTL_RGB; 
        switch (rotation) {
            case 0:
            case 2:
            default:
